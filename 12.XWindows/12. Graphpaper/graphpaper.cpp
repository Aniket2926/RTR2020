...
void CreateWindow(void)
{
    ...
    */
    ...
    gColormap=winAttribs.colormap;
     ...
     XStoreName(gpDisplay,gWindow,"Aniket:Graph paper XWindow");
...
void ToggleFullscreen(void)
{
   ...
   void Initialize(void)
     ...
     {
         static float y ;
	     static float y_num = 0.060f;

	     static float x;
	     static float x_num = 0.11f;
        ...
        for (y = y_num; y <= (y_num * 20); y = y + y_num)
	    for (x = x_num; x <= (x_num * 20); x = x + x_num)
	        {
