...

{
	...
	TCHAR str[] = TEXT("Happy Guru Purnima !!!");  // string 
	...
	case WM_LBUTTONDOWN:     // wm_paint kadun magic of msg 

		GetClientRect(hwnd, &rc);          // OS i need client rectangle hwnd and rc are parameter 

		hdc = GetDC(hwnd);                       //  it will color whole surface not smallest

		SetBkColor(hdc, RGB(0, 0, 255)); // Background color RGB is speacilist
		...
		ReleaseDC(hwnd, hdc);             // end of my painting hwnd
		break;
