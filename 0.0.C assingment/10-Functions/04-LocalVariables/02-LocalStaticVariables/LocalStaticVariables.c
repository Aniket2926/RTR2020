...
{ 
    ...
    // variable declarations // 'a' is a Local Variable. It is local to main() only.
    int a = 5;
    ...
    // So local_count is 1 // local_count = local_count + 1 = 1 + 1 = 2 
    change_count();
...
void change_count(void)
{
  ...
  // variable declarations // 'local_count' is a Local Static Variable. It is local to change_count() only.
