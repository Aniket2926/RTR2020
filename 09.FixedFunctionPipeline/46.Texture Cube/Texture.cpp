...
//new macros
//#define MY_ICON 2926
//#define stone_bitmap 2927

//#define kundali_bitmap 2928
...
void initialize(void)
{
	...
	bool loadGLTexture(GLuint*, TCHAR[]);  // 1st change text
...
bool loadGLTexture(GLuint* Texture, TCHAR resourceID[])  
{
	...
	HBITMAP hBitmap = NULL; // os image loading line native they will be change every time 
	BITMAP bmp;

	bool bResult = false;  // c++ cha false and bool

	// Code 

   //0,0 dena icon nahi image ahe,6 para kasa load karu native formate ne, file nahi ye resource hee sangta, Device independent bitmap DIB 
	...
	if (hBitmap)
	{
		...
		GetObject(hBitmap, sizeof(BITMAP), &bmp);  // bmp strcut a 7 para 

		// OpenGL Texture Code
		
		glPixelStorei(GL_UNPACK_ALIGNMENT, 4); // 1 image memory kashi pahijhe tr unpacked pahijhe , 2 RGBA

		// Texture cha object tayar kar 
		...
		// following call will push data in memory with the help of graphic 
...
void display(void)
{
	...
	glLoadIdentity();
	glTranslatef(-1.5f, 0.0f, -6.0f);   // 4th change for prespective 
...
void pyramid(void)
{
	...
	glTexCoord2f(0.5f, 1.0f);      // ..........................................for texture 
...
void cube(void)
{
	...
	glBegin(GL_QUADS);
	//..................... ..................Front  .............. Front ahe so Z are positive 
	...
	glTexCoord2f(1.0f, 1.0f);
	glVertex3f(-1.0f, -1.0f, -1.0f);//  left b0ttom
