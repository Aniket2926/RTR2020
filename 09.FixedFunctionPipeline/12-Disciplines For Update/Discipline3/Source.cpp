...
GLfloat angle = 0.0f;  //spining discipline 2
	...
	while (BDone == false)  // game loop
	{
		...
		else
		{
			if (gbActiveWindow == true)
			{
				...
				display();
				update(); // discipline 3 // so prototype is in winmain and swap buffer cha adhi lihila tari chalt0
			}
