...
void display(void)
{
	...
	glVertex3f(-0.1f, 0.1f, 0.0f); //1

	glVertex3f(-0.1f, -0.1f, 0.0f);
	glVertex3f(0.1f, -0.1f, 0.0f);//2

	glVertex3f(0.1f, -0.1f, 0.0f);
	glVertex3f(0.1f, 0.1f, 0.0f); //3
	...
	glVertex3f(-0.2f, 0.2f, 0.0f); //1

	glVertex3f(-0.2f, -0.2f, 0.0f);
	glVertex3f(0.2f, -0.2f, 0.0f);//2

	glVertex3f(0.2f, -0.2f, 0.0f);
	glVertex3f(0.2f, 0.2f, 0.0f); //3
	...
	glVertex3f(-0.3f, 0.3f, 0.0f); //1

	glVertex3f(-0.3f, -0.3f, 0.0f);
	glVertex3f(0.3f, -0.3f, 0.0f);//2

	glVertex3f(0.3f, -0.3f, 0.0f);
	glVertex3f(0.3f, 0.3f, 0.0f); //3

	glVertex3f(0.3f, 0.3f, 0.0f);
	glVertex3f(-0.3f, 0.3f, 0.0f); //4
	...
	glVertex3f(-0.4f, 0.4f, 0.0f); //1

	glVertex3f(-0.4f, -0.4f, 0.0f);
	glVertex3f(0.4f, -0.4f, 0.0f);//2

	glVertex3f(0.4f, -0.4f, 0.0f);
	glVertex3f(0.4f, 0.4f, 0.0f); //3

	glVertex3f(0.4f, 0.4f, 0.0f);
	glVertex3f(-0.4f, 0.4f, 0.0f); //4
	...
	glVertex3f(-0.6f, 0.6f, 0.0f); //1

	glVertex3f(-0.6f, -0.6f, 0.0f);
	glVertex3f(0.6f, -0.6f, 0.0f);//2

	glVertex3f(0.6f, -0.6f, 0.0f);
	glVertex3f(0.6f, 0.6f, 0.0f); //3

	glVertex3f(0.6f, 0.6f, 0.0f);
	glVertex3f(-0.6f, 0.6f, 0.0f); //4



	//7 grey 0.752941 green 0.752941 blue 0.752941
	glColor3f(0.752941f, 0.752941f, 0.752941f);

	glVertex3f(-0.7f, -0.7f, 0.0f);
	glVertex3f(-0.7f, 0.7f, 0.0f); //1

	glVertex3f(-0.7f, -0.7f, 0.0f);
	glVertex3f(0.7f, -0.7f, 0.0f);//2

	glVertex3f(0.7f, -0.7f, 0.0f);
	glVertex3f(0.7f, 0.7f, 0.0f); //3

	glVertex3f(0.7f, 0.7f, 0.0f);
	glVertex3f(-0.7f, 0.7f, 0.0f); //4
	...
	glVertex3f(-0.8f, 0.8f, 0.0f); //1

	glVertex3f(-0.8f, -0.8f, 0.0f);
	glVertex3f(0.8f, -0.8f, 0.0f);//2

	glVertex3f(0.8f, -0.8f, 0.0f);
	glVertex3f(0.8f, 0.8f, 0.0f); //3

	glVertex3f(0.8f, 0.8f, 0.0f);
	glVertex3f(-0.8f, 0.8f, 0.0f); //4




	//9color   neon pink red 1.00 green 0.43 blue 0.78
	glColor3f(1.0f, 0.43f, 0.78f);

	
	glVertex3f(-0.9f, -0.9f, 0.0f);
	glVertex3f(-0.9f, 0.9f, 0.0f); //1

	glVertex3f(-0.9f, -0.9f, 0.0f);
	glVertex3f(0.9f, -0.9f, 0.0f);//2

	glVertex3f(0.9f, -0.9f, 0.0f);
	glVertex3f(0.9f, 0.9f, 0.0f); //3

	glVertex3f(0.9f, 0.9f, 0.0f);
	glVertex3f(-0.9f, 0.9f, 0.0f); //4
