...
void display(void)
{
	...
	glTranslatef(0.0f, 0.0f, -10.0f);   // 4th change for prespective 
	...
	glColor3f(1.0f, 0.0f, 0.0f);   //***********  Horizontal **********

	glVertex3f(-4.0f, 0.0f, 0.0f);
	glVertex3f(4.0f, 0.0f, 0.0f);

	// upper side of x axis
	glColor3f(0.0f, 0.0f, 1.0f);

	glVertex3f(-4.0f, 0.2f, 0.0f);
	glVertex3f(4.0f, 0.2f, 0.0f); //1 

	glVertex3f(-4.0f, 0.4f, 0.0f);
	glVertex3f(4.0f, 0.4f, 0.0f);//2

	glVertex3f(-4.0f, 0.6f, 0.0f);
	glVertex3f(4.0f, 0.6f, 0.0f);   //3


	glVertex3f(-4.0f, 0.8f, 0.0f);
	glVertex3f(4.0f, 0.8f, 0.0f);  //4

	glVertex3f(-4.0f, 1.0f, 0.0f);
	glVertex3f(4.0f, 1.0f, 0.0f);  //5

	glVertex3f(-4.0f, 1.2f, 0.0f);
	glVertex3f(4.0f, 1.2f, 0.0f); //6

	glVertex3f(-4.0f, 1.4f, 0.0f);
	glVertex3f(4.0f, 1.4f, 0.0f);  //7

	glVertex3f(-4.0f, 1.6f, 0.0f);
	glVertex3f(4.0f, 1.6f, 0.0f); //8

	glVertex3f(-4.0f, 1.8f, 0.0f);
	glVertex3f(4.0f, 1.8f, 0.0f);  //9

	glVertex3f(-4.0f, 2.0f, 0.0f);
	glVertex3f(4.0f, 2.0f, 0.0f);  //10

	glVertex3f(-4.0f, 2.2f, 0.0f);
	glVertex3f(4.0f, 2.2f, 0.0f);  //11

	glVertex3f(-4.0f, 2.4f, 0.0f);
	glVertex3f(4.0f, 2.4f, 0.0f);  //12

	glVertex3f(-4.0f, 2.6f, 0.0f);
	glVertex3f(4.0f, 2.6f, 0.0f); //13

	glVertex3f(-4.0f, 2.8f, 0.0f);
	glVertex3f(4.0f, 2.8f, 0.0f);// 14

	glVertex3f(-4.0f, 3.0f, 0.0f);
	glVertex3f(4.0f, 3.0f, 0.0f);  //15

	glVertex3f(-4.0f, 3.2f, 0.0f);
	glVertex3f(4.0f, 3.2f, 0.0f);  //16

	glVertex3f(-4.0f, 3.4f, 0.0f);
	glVertex3f(4.0f, 3.4f, 0.0f);  //17

	glVertex3f(-4.0f, 3.6f, 0.0f);
	glVertex3f(4.0f, 3.6f, 0.0f); //18

	glVertex3f(-4.0f, 3.8f, 0.0f);
	glVertex3f(4.0f, 3.8f, 0.0f);// 19


	glVertex3f(-4.0f, 4.0f, 0.0f);
	glVertex3f(4.0f, 4.0f, 0.0f); //20
	...
	glVertex3f(-0.2f, -4.0f, 0.0f); // 1

	glVertex3f(-0.4f, 4.0f, 0.0f);
	glVertex3f(-0.4f, -4.0f, 0.0f); //2

	glVertex3f(-0.6f, 4.0f, 0.0f);
	glVertex3f(-0.6f, -4.0f, 0.0f); //3

	glVertex3f(-0.8f, 4.0f, 0.0f);
	glVertex3f(-0.8f, -4.0f, 0.0f);//4 

	glVertex3f(-1.0f, 4.0f, 0.0f);
	glVertex3f(-1.0f, -4.0f, 0.0f); //5

	glVertex3f(-1.2f, 4.0f, 0.0f);
	glVertex3f(-1.2f, -4.0f, 0.0f); //6 

	glVertex3f(-1.4f, 4.0f, 0.0f);
	glVertex3f(-1.4f, -4.0f, 0.0f); //7

	glVertex3f(-1.6f, 4.0f, 0.0f);
	glVertex3f(-1.6f, -4.0f, 0.0f);//8

	glVertex3f(-1.8f, 4.0f, 0.0f);
	glVertex3f(-1.8f, -4.0f, 0.0f);//9

	glVertex3f(-2.0f, 4.0f, 0.0f);
	glVertex3f(-2.0f, -4.0f, 0.0f); //10

	glVertex3f(-2.2f, 4.0f, 0.0f);
	glVertex3f(-2.2f, -4.0f, 0.0f); //11

	glVertex3f(-2.4f, 4.0f, 0.0f);
	glVertex3f(-2.4f, -4.0f, 0.0f); //12

	glVertex3f(-2.6f, 4.0f, 0.0f);
	glVertex3f(-2.6f, -4.0f, 0.0f);//13

	glVertex3f(-2.8f, 4.0f, 0.0f);
	glVertex3f(-2.8f, -4.0f, 0.0f);//14

	glVertex3f(-3.0f, 4.0f, 0.0f);
	glVertex3f(-3.0f, -4.0f, 0.0f); //15

	glVertex3f(-3.2f, 4.0f, 0.0f);
	glVertex3f(-3.2f, -4.0f, 0.0f); //16

	glVertex3f(-3.4f, 4.0f, 0.0f);
	glVertex3f(-3.4f, -4.0f, 0.0f); //17

	glVertex3f(-3.6f, 4.0f, 0.0f);
	glVertex3f(-3.6f, -4.0f, 0.0f);//18

	glVertex3f(-3.8f, 4.0f, 0.0f);
	glVertex3f(-3.8f, -4.0f, 0.0f);//19
	...
	glVertex3f(-2.0f, 1.0f, 0.0f);  //A
	glVertex3f(2.0f, 1.0f, 0.0f);

	glVertex3f(-2.0f, 1.0f, 0.0f);  //b
	glVertex3f(-2.0f, -1.0f, 0.0f);

	glVertex3f(-2.0f, -1.0f, 0.0f); //c
	glVertex3f(2.0f, -1.0f, 0.0f);

	glVertex3f(2.0f, -1.0f, 0.0f); //d
	glVertex3f(2.0f, 1.0f, 0.0f);
