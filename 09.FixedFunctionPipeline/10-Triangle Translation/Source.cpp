...
{
	//code
	static GLfloat x = 0.0f;// translation
	...
	glTranslatef(x, 0.0f, -3.0f);   // 4th change for prespective  //c x axis movemet
	...
	x = x + 0.0001f; // translation
	if (x >= 2.0f) // translation continous
	{
		x = -2.0f;
	}

	angle = angle + 0.1f;// rotation
