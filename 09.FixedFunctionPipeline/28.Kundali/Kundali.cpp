...
void display(void)
{
	...
	glVertex3f(1.5f, 1.0f, 0.0f); //1

	
	glVertex3f(-1.5f, 1.0f, 0.0f);
	glVertex3f(-1.5f, -1.0f, 0.0f); //2
	

	glVertex3f(-1.5f, -1.0f, 0.0f);
	glVertex3f(1.5f, -1.0f, 0.0f); //3

	
	glVertex3f(1.5f, 1.0f, 0.0f);
	glVertex3f(1.5f, -1.0f, 0.0f); //4

	glVertex3f(-1.5f, 1.0f, 0.0f);
	glVertex3f(1.5f, -1.0f, 0.0f); //5


	glVertex3f(-1.5f, -1.0f, 0.0f);
	glVertex3f(1.5f, 1.0f, 0.0f); //6

	glVertex3f(0.0f, 1.0f, 0.0f);
	glVertex3f(-1.5f, 0.0f, 0.0f); //7


	glVertex3f(-1.5f, 0.0f, 0.0f);
	glVertex3f(0.0f, -1.0f, 0.0f); //8

	glVertex3f(0.0f, -1.0f, 0.0f);
	glVertex3f(1.5f, 0.0f, 0.0f); //9

	glVertex3f(0.0f, 1.0f, 0.0f);
	glVertex3f(1.5f, 0.0f, 0.0f); //10
