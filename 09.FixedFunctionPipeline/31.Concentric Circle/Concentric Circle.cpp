...
void display(void)
{
	...
	for (angle = 0.0f; angle < 2 * 3.14159; angle += 0.001f)
	{
		glVertex3f(0.3f * cosf(angle), 0.3f * sinf(angle), 0.0f);
	}
	...
	for (angle = 0.0f; angle < 2 * 3.14159; angle += 0.001f)
	{
		glVertex3f(0.5f * cosf(angle), 0.5f * sinf(angle), 0.0f);
	}
	...
	for (angle = 0.0f; angle < 2 * 3.14159; angle += 0.001f)
	{
		glVertex3f(0.6f * cosf(angle), 0.6f * sinf(angle), 0.0f);
	}
	...
	for (angle = 0.0f; angle < 2 * 3.14159; angle += 0.001f)
	{
		glVertex3f(0.7f * cosf(angle), 0.7f * sinf(angle), 0.0f);
	}
	...
	for (angle = 0.0f; angle < 2 * 3.14159; angle += 0.001f)
	{
		glVertex3f(0.9f * cosf(angle), 0.9f * sinf(angle), 0.0f);
	}
	...
	for (angle = 0.0f; angle < 2 * 3.14159; angle += 0.001f)
	{
		glVertex3f(1.0f * cosf(angle), 1.0f * sinf(angle), 0.0f);
	}
	...
	for (angle = 0.0f; angle < 2 * 3.14159; angle += 0.001f)
	{
		glVertex3f(0.1f * cosf(angle), 0.1f * sinf(angle), 0.0f);
	}
